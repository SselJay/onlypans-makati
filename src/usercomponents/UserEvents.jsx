                        ...
                        <div className="row m-2 d-flex flex-md-row flex-sm-column flex-align-items-center justify-content-evenly eventTwo">
                                ...
                                <div className="card cardI mb-3">
                                    <div className="row g-0">
                                        <div className="col-md-12">
                                            <img src="img/Events/Events1/EventAresized.png"
                            ...
                            <div className="col">
                                <div className="card cardI mb-3">
                                    <div className="row g-0">
                                        <div className="col-md-12">
                                            <img src="img/Events/Events3/PopUpresized.png"
                        ...
                        <div
                            ...
                            <div className="col">
                                <div className="card cardI mb-3">
                                    <div className="row g-0">
                                        <div className="col-md-12">
                                            <img src="img/Events/Events2/TyphoonOdette.png"
                            ...
                            <div className="col">
                                <div className="card cardI mb-3">
                                    <div className="row g-0">
                                        <div className="col-md-12">
                                            <img src="img/Events/Events2/PrideMonthresized.png"
